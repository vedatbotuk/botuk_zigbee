...
/**
 * Custom cluster definition for the irrigation/light controller
 */
const createCustomClustersController = () => [
...
// Definition for 24672_122 (Irrigation and Light Controller)
const definition_24672_122 = {
    ...
    extend: [
        ...createCustomClustersController(),
        temperature(),
        humidity(),
    ...
    fromZigbee: [
        {
            cluster: [0x0006, 0xfc0c],
            type: ["attributeReport", "readResponse"],
            convert: (model, msg, publish, options, meta) => {
                const state = msg.data.onOff !== undefined ? (msg.data.onOff ? "ON" : "OFF") : null;
                if (state) {
                    const clusterMap = { 6: "state_light", 64524: "state_irrigation" };
                    return { [clusterMap[msg.cluster]]: state };
                }
            },
        },
 ...
 */
module.exports = [definition_16512_125, definition_16512_127, definition_50304_126, definition_24672_122, definition_54272_127];
