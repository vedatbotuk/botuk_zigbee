const definition = {
  zigbeeModel: ['33280_127'], // The model ID from: Device with modelID 'lumi.sens' is not supported.
  model: '33280_127', // Vendor model number, look on the device for a model number
