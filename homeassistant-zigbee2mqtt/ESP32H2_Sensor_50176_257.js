...
const definition = {
  zigbeeModel: ['50176_257'], // The model ID from: Device with modelID 'lumi.sens' is not supported.
  model: '50176_257', // Vendor model number, look on the device for a model number
