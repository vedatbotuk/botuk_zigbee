...
void zb_update_co2(float eco2)
{
    ...
    {
        ESP_LOGW(TAG_ZB_UPDATE_CO2, "Device is not connected! Could not update CO2 value");
    }
}
...
void zb_report_co2()
{
    ...
    {
        ESP_LOGW(TAG_ZB_UPDATE_CO2, "Device is not connected! Could not report CO2 value");
    }
}
